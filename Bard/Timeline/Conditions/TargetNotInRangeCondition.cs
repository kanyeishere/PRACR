...
namespace Wotou.Bard.Timeline.Conditions;

public class TargetNotInRangeCondition
    : ICondition, ISerializableCondition, IJobNodeDescriptor
{
    ...
    public string NodeDisplayName => "通用/判断所有目标不在范围内";
    ...
    {
        ConditionFactory.Register(context, "targetnotinrange", dto =>
        {
            var c = new TargetNotInRangeCondition();
